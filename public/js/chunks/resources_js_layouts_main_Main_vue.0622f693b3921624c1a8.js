          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 3:
                ...
                _this.$store.commit('MENU_ACTIVE', _this.$route.meta.name);

                console.log(_this.$store.state.avtiveMenuBtn);
                _context.next = 13;
                break;
          ...
          _c(
            ...
            [
              ...
              _c(
                "div",
                { staticClass: "pt-3" },
                _vm._l(_vm.$store.state.menuList, function(item, index) {
                  return _c(
                    "div",
                    {
                      key: index,
                      class:
                        item.name == _vm.$store.state.avtiveMenuBtn
                          ? "d-flex layout--menu-item-container layout--menu-item-container-active"
                          : "d-flex layout--menu-item-container"
                    },
                    [
                      _c("i", {
                        class: "fas fa-" + item.icon + " layout--menu-item-icon"
                      }),
                      _vm._v(" "),
                      _c("div", { staticClass: "layout--menu-item-title" }, [
