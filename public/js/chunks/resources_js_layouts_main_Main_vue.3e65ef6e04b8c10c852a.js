...
var render = function() {
  ...
  return _c(
    "div",
    { staticClass: "layout--vnav" },
    [
      _c("layout-menubar", {
        attrs: {
          iconContainerWidth: _vm.menu.iconContainerWidth,
          listContainerWidth: _vm.menu.listContainerWidth,
      ...
      _c(
        "layout-body",
        { attrs: { iconContainerWidth: _vm.menu.iconContainerWidth } },
        [
          _c("layout-header", {
            attrs: { iconContainerWidth: _vm.menu.iconContainerWidth }
          }),
