  ...
  methods: {
    ...
    searchData: function searchData() {
      if (this.usercatagiryId == null) {
        ale.fire({
          title: 'Please select user catagory.'
        });
      } else {
        //api searched will done here
        this.searched = false;
        var startDate = moment__WEBPACK_IMPORTED_MODULE_0___default()(this.dateRange.start);
        var endDate = moment__WEBPACK_IMPORTED_MODULE_0___default()(this.dateRange.end);
        var duration = moment__WEBPACK_IMPORTED_MODULE_0___default().duration(endDate.diff(startDate));
        var days = duration.asDays(); //Room item from api
        ...
        this.roomItems = [{
          ...
          bookingUrl: "/booking/".concat(this.usercatagiryId, "/0/").concat(this.adult, "/").concat(this.children)
        }, {
          ...
          address: 'Address will go here',
          bookingUrl: "/booking/".concat(this.usercatagiryId, "/1/").concat(this.adult, "/").concat(this.children)
        }];
      }
    }
  }
            ...
            _c("div", { staticClass: "pa-3 cc-full-page-inp-container" }, [
              ...
              _c("div", { staticClass: "d-flex pa-3" }, [
                _c(
                  "div",
                  {
                    staticClass: "mx-1 px-2 py-2 flex-grow-1 input-border",
                ...
                _c(
                  "div",
                  {
                    staticClass: "mx-1 px-2 py-2 input-border",
                    staticStyle: { "background-color": "#FFFFFF" }
                  },
                  [
                    _c("v-date-picker", {
                ...
                _c(
                  "div",
                  {
                    staticClass: "mx-1 py-2 px-2 input-border",
                    staticStyle: { "background-color": "#FFFFFF" }
                  },
                  [
                    _c(
                                ...
                                return [
                                  _c(
                                    ...
                                    _vm._g(
                                      _vm._b(
                                        {
                                          staticClass: "d-flex pt-3 text-h6",
                                          staticStyle: {
                                            width: "230px",
                                            cursor: "pointer"
                                          }
                          ...
                          _c(
                            ...
                            [
                              ...
                              _c(
                                ...
                                {
                                  staticClass: "d-flex py-2",
                                  staticStyle: { color: "#4f4f4f" }
                                },
                                [
                                  _c("div", { staticStyle: { flex: "1" } }, [
                                    _c("div", [
                                      _c("b", [_vm._v("Number of beds:")]),
                                      _vm._v(" " + _vm._s(item.night))
                                    ]),
                                    _vm._v(" "),
                                    _c("div", [
                                      _c("b", [_vm._v("Night:")]),
                                  ...
                                  _c("div", { attrs: { align: "right" } }, [
                                    _c("div", [
                                      _c("b", [_vm._v("Total ammount:")]),
                                      _vm._v(" " + _vm._s(item.cost))
                                    ]),
                                    _vm._v(" "),
                                    _c("div", [
                                      _c("b", [_vm._v("+ vat:")]),
                                      _vm._v(" " + _vm._s(item.tax))
                                    ]),
                                    _vm._v(" "),
                                    _c(
                                      "div",
...
var staticRenderFns = [
  function() {
    ...
    return _c("div", { staticClass: "px-4 py-3 text-h5" }, [
      _c("div", { staticClass: "font-weight-bold font-italic" }, [
        _vm._v("Find the right hotel in right time")
      ]),
      _vm._v(" "),
      _c("div", { staticStyle: { "font-size": "12px", color: "#8f8f8f" } }, [
        _vm._v("Some instruction should go here.")
      ])
    ])
  }
]
