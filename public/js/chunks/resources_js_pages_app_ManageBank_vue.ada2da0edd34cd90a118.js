...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.prev = 0;
                _context.next = 3;
                return axios.get('/api/bank/detail');
              ...
              case 3:
                ...
                if (req.status == 200) {
                  if (req.data.bank == true) {
                    _this.editModeName = "Update Bank Info";
                    _this.bankExist = true;
                    _this.bankInfo = req.data;
                    _this.bankName = req.data.bankName;
                    _this.branchName = req.data.branchName;
                    _this.accountType = req.data.accountType;
                    _this.accountName = req.data.accountName;
                    _this.accountNumber = req.data.accountNumber;
                  }
                }
    ...
    manageBank: function manageBank() {
      var _this2 = this;
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                _this2.errorData = {};
                data = {
                  bankName: _this2.bankName,
                  branchName: _this2.branchName,
                  accountType: _this2.accountType,
                  accountName: _this2.accountName,
                  accountNumber: _this2.accountNumber
                };
                _context2.prev = 2;

                if (!(_this2.bankExist == true)) {
                  _context2.next = 9;
                  break;
                }

                _context2.next = 6;
                return axios.put('/api/bank/update', data);
              ...
              case 9:
                _context2.next = 11;
                return axios.post('/api/bank/create', data);
                  ...
                  [
                    _c("b-col", { attrs: { lg: "6", md: "12", sm: "12" } }, [
                      ...
                      _c("div", { staticClass: "d-flex py-1" }, [
                        ...
                        _c("div", [_vm._v(_vm._s(_vm.bankInfo.currentBalance))])
                      ])
                    ]),
                    _vm._v(" "),
                    _c("b-col", { attrs: { lg: "6", md: "12", sm: "12" } }, [
