...
var render = function() {
  ...
  return _c(
    ...
    [
      _c("layout-menubar", {
        attrs: { menuWidth: _vm.menuAdjWidth, menuStatus: "menuStatus" }
      }),
      _vm._v(" "),
      _c(
        "layout-body",
        ...
        [
          _c("layout-header", { attrs: { menuWidth: _vm.menuAdjWidth } }),
          _vm._v(" "),
...
var staticRenderFns = [
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "layout--vnav-header" }, [
